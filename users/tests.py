...
class UserModelTest(TestCase):
    ...
    def test_usertelegram_link(self):
        """Тест связи пользователя с Telegram."""
...
class UserSerializerTest(APITestCase):
    """Тесты сериализаторов пользователя."""
    ...
    def test_user_telegram_serializer(self):
        """Тест сериализатора Telegram профиля."""
...
class UserTelegramPermissionTest(TestCase):
    """Тесты разрешений для Telegram профиля."""
