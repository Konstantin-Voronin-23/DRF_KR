        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "action",
                    models.CharField(
                        help_text="Укажите действие", max_length=255, verbose_name="Действие - что делать"
                    ),
                ),
                (
                    "time",
                ...
                (
                    "place",
                    models.CharField(
                        help_text="Укажите место выполнения", max_length=255, verbose_name="Место выполнения привычки"
                    ),
                ),
                (
                    "periodicity",
